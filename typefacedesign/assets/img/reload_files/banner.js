...
bannerboy.main = function() {
	...
	bannerboy.preloadImages(images, function() {
		...
		var website_txt = bannerboy.createElement({left: 268, top: 40, width: 194, height: 25, parent: banner});
			var website_txt_1 = bannerboy.createElement({backgroundImage: "website_txt_1.png", retina: true, parent: website_txt});
			var website_txt_2 = bannerboy.createElement({backgroundImage: "website_txt_2.png", left: 42, top: 19, retina: true, parent: website_txt});
		var logo = bannerboy.createElement({backgroundImage: "logo.png", left: 293, top: 36, retina: true, parent: banner});
		var headline = bannerboy.createElement({backgroundImage: "headline.png", left: 339, top: 58, retina: true, parent: banner});
		var logo_squarespace = bannerboy.createElement({id: "logo_squarespace", backgroundImage: "logo_squarespace.png", left: 37, top: 37, retina: true, parent: banner});
		...
		var cta = bannerboy.createElement({id: "cta", right: 15, top: 28, width: 135, height: 32, parent: banner});
			var cta_base = bannerboy.createElement({id: "cta_base", backgroundColor: "#ffffff", right: 0, width: 135, height: 32, parent: cta});
			var cta_txt = bannerboy.createElement({id: "cta_txt", backgroundImage: "cta_txt.png", right: 15, top: 14, retina: true, parent: cta});
		...
		// var guide = bannerboy.createElement({backgroundImage: "guide.png", left: 0, top: -5, opacity: 0.7, retina: true, parent: banner});
		/* Adjustments
		================================================= */
		...
		function animations() {
			...
			.from(image_1, 5.2, {scale: 1.15, ease: Linear.easeNone});
